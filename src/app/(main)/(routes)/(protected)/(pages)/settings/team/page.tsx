          ...
          <CardContent className="p-8">
            ...
            <div className="flex flex-col justify-between space-y-4 sm:flex-row md:space-x-4">
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  If you leave the team as leader, a random member will become
                  leader. Leaving a team as the only member will delete the
                  team.
                </p>
              </div>
            ...
            <div className="mt-6 flex flex-col justify-between space-y-4 sm:flex-row md:space-x-4">
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  You can delete your team. This will kick all members off the
                  team.
                </p>
              </div>
      ...
      <Card>
        <CardContent className="flex h-full items-center justify-between gap-4 p-6 text-sm">
          <p className="text-md text-muted-foreground">
            To view and edit team details, you must be part of a team.
          </p>
