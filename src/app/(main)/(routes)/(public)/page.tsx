  ...
  return (
    <Section className="bg-background">
      <div className="flex justify-center lg:justify-between">
        <div className="flex flex-col items-center max-w-xl space-y-8 text-center lg:text-left lg:items-start">
          ...
          <Button variant="default" className="w-48 text-md" asChild>
  ...
  return (
    <Section className="bg-background-variant dark:bg-background/60 border-y">
      <div className="grid grid-cols-5 gap-8">
        <div className="justify-center hidden md:col-span-2 md:flex">
          {/* eslint-disable-next-line @typescript-eslint/no-unsafe-assignment */}
        ...
        <div className="justify-center hidden p-6 md:col-span-2 md:flex">
          {/* eslint-disable-next-line @typescript-eslint/no-unsafe-assignment */}
          <Image alt="Graphical Element" src={HomeInfo2Svg} width={210} height={250} />
        </div>

        <hr className="col-span-full" />
        <div className="items-center justify-center hidden p-6 md:col-span-2 md:flex">
          {/* eslint-disable-next-line @typescript-eslint/no-unsafe-assignment */}
          <Image alt="Graphical Element" src={HomeInfo3Svg} width={160} />
        </div>
        <Card className="p-6 col-span-full text-foreground/80 md:col-span-3">
...
function HomeRules() {
  return (
    <Section className="mx-auto bg-background">
      <p className="text-4xl font-bold text-center text-foreground">RULES</p>
      <div className="grid items-start grid-cols-1 gap-8 my-6 mt-8 place-items-center md:grid-cols-3">
        <div className="flex flex-col items-center">
          <User className="w-8 h-8 text-xl text-foreground" />
        ...
        <div className="flex flex-col items-center">
          <Scale className="w-8 h-8 text-xl text-foreground" />
        ...
        <div className="flex flex-col items-center">
          <Smile className="w-8 h-8 text-xl text-foreground" />
    ...
    <Section className="border-y bg-primary/90">
      <div className="flex flex-row justify-center space-x-12">
        <Card className="bg-background-banana border-black max-w-[32rem]">
          <CardHeader>
            <CardTitle className="text-3xl dark:text-background">PRIZES</CardTitle>
  ...
  return (
    <Section className="bg-background-variant-other">
      <div className="mx-auto grid max-w-[30rem] gap-y-8 md:max-w-[60rem]">
        ...
        <Card>
          <div className="grid grid-cols-1 gap-8 p-6 rounded-xl md:grid-cols-2">
            <Image
              alt="fall-2023-event"
            ...
            <div className="flex flex-col justify-between">
              ...
              <Button className="w-32 mt-auto ml-auto text-md" asChild>
                <Link
