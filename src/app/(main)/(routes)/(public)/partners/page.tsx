...
import MicrochipLogo from "@/../public/sponsors/Microchip_Logo.png";
        ...
        <div className="flex flex-row justify-between space-x-4 py-6">
          <div className="flex flex-col justify-center space-y-6 md:space-y-4">
            ...
            <p className="max-w-3xl">
              ...
              unforgettable, and we&apos;re excited to introduce them to you!
            </p>
          </div>
...
function PartnerSpotCard({
  name,
  description,
  image_src,
  image_alt,
  partner_url,
}: PartnerSpotCardProps) {
  return (
...
function createPartnerSpotCards(allPartners: PartnerDetail[]) {
  ...
  allPartners.forEach((partnerDetails, partnerIndex) =>
...
function PartnersInfo() {
  const partnerDetails: PartnerDetail[] = [
    ...
    },
    {
      name: "Amphenol",
      description:
        "Amphenol is a global leader in high-technology interconnect, sensor, and antenna solutions, serving a wide range of markets such as automotive, broadband communications, aerospace, defense, and IT. The company's extensive product range supports essential applications across diverse industries, demonstrating its significant expertise and impact.",
